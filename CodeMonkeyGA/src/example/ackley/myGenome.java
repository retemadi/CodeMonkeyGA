...
public class myGenome extends RealArrayListGenome {
	...
	private static RealBoundary[] boundary = {
			new RealBoundary(-32,true,32,true),
			new RealBoundary(-32,true,32,true),
			new RealBoundary(-32,true,32,true),
			new RealBoundary(-32,true,32,true),
			new RealBoundary(-32,true,32,true),
	...
	public void recombineRealListLocal(myGenome genome, double recombinationRate) {
		RealOperator.recombineRealListLocal(this, genome, recombinationRate);
	}
