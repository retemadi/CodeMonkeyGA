...
public class EvolutionProcess extends Evolution<Phenome> {
	...
	public static void main(String[] args) throws ESException, IOException {
		...
		//external.RuleSetNImageAnalyser.output2PGM(fittestRuleSet, "Fittest.Test."+time+".pgm");
		//external.RuleSetNImageAnalyser.printStats();
		external.RuleSetNImageAnalyser.readApplyCalculateRMS4All(fittestRuleSet);
		return;
	}
