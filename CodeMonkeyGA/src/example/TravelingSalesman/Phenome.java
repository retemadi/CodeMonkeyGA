...
public class Phenome extends Phenotype<myGenome, Double> {
	...
	public void evaluate(HashMap<String,String> externalData) {
		//TODO Use the this.genome and externalData (if not null) 
		//to evaluate and set the this.fitnessValue
		Integer[] xArr = this.genome.toArray(new Integer[genome.size()]);
		this.fitnessValue = external.TravelingSalesman.evaluate(xArr);
		return; 
	}
