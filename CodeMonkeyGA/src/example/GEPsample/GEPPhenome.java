...
import example.GEPsample.myGenome;

public class GEPPhenome extends Phenotype<myGenome, Double> {
...
/* for sample GA
		Integer rawVal = (Integer)express();
		double val = Math.pow(rawVal,2);
		if (val > 3969.0) fitnessValue = 0.0;
		else fitnessValue = val;
		return; 
	}
*/	
...
*/	
	 ...
	 * constructor
	 */
	public GEPPhenome(myGenome gen) {
		genome = gen;
		fitnessValue = 0.0;
	}
