...
public class myGenomePart2 extends BooleanArrayListGenome {

	private static final long serialVersionUID = 1L;

	public myGenomePart2() {
		super();
		initialSize=6;
	}
	...
	public void recombineBooleanListOnePoint(myGenomePart2 genome, double recombinationRate) {
	...
	public void recombineBooleanListTwoPoint(myGenomePart2 genome, double recombinationRate) {
	...
	public void recombineBooleanListUniform(myGenomePart2 genome, double recombinationRate) {
	...
	public BooleanArrayListGenome create() { 
		return new myGenomePart2();
	}

	@Override
	public myGenomePart2 clone() { 
	return (myGenomePart2)super.clone();
	}
