...
public class myGenomePart4 extends BooleanArrayListGenome {

	private static final long serialVersionUID = 1L;

	public myGenomePart4() {
		super();
		initialSize=6;
	}
	...
	public void recombineBooleanListOnePoint(myGenomePart4 genome, double recombinationRate) {
	...
	public void recombineBooleanListTwoPoint(myGenomePart4 genome, double recombinationRate) {
	...
	public void recombineBooleanListUniform(myGenomePart4 genome, double recombinationRate) {
	...
	public BooleanArrayListGenome create() { 
		return new myGenomePart4();
	}

	@Override
	public myGenomePart4 clone() { 
	return (myGenomePart4)super.clone();
	}
