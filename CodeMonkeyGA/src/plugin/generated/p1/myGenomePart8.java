...
public class myGenomePart8 extends BooleanArrayListGenome {

	private static final long serialVersionUID = 1L;

	public myGenomePart8() {
		super();
		initialSize=5;
	}
	...
	public void recombineBooleanListOnePoint(myGenomePart8 genome, double recombinationRate) {
	...
	public void recombineBooleanListTwoPoint(myGenomePart8 genome, double recombinationRate) {
	...
	public void recombineBooleanListUniform(myGenomePart8 genome, double recombinationRate) {
	...
	public BooleanArrayListGenome create() { 
		return new myGenomePart8();
	}

	@Override
	public myGenomePart8 clone() { 
	return (myGenomePart8)super.clone();
	}
